...
<body>
	...
	<div class="nav">
		...
		<span class="menuButton"><g:link class="list" action="list">Rolle List</g:link></span>
		<span class="menuButton"><g:link class="create" action="create">New Rolle</g:link></span>
	</div>
	...
	<div class="body">
		...
		<g:form>
			...
			<tbody>
				<tr class="prop">
					<td valign="top" class="name"><label for="authority">Rolle Name:</label></td>
